...
class SaisieVenteScreen extends StatefulWidget {
  const SaisieVenteScreen({super.key});

  @override
  State<SaisieVenteScreen> createState() => _SaisieVenteScreenState();
}

class _SaisieVenteScreenState extends State<SaisieVenteScreen> {
  ...
  Future<void> _enregistrer() async {
    ...
    if (ok) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Vente enregistrée.'), backgroundColor: AppColors.primary),
      );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Enregistrer une vente')),
      body: Form(
        key: _formKey,
        child: ListView(
